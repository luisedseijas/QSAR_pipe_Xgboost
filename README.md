...
- **DrugBank Prediction**: Predicts pIC50 for new compounds using PCA-based Applicability Domain (`drugbank_predictor.py`).
...
- **Scripts** (Managed by the interface):
    ...
    - `drugbank_predictor.py`: **Phase 3**. New compound prediction.
- **`data/`**:
